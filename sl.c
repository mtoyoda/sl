 ...
 *========================================
 */
/* sl version 5.02 : Added in random chance to actually call "ls"            */
/*                   Makes the bug in "man" valid.                           */
/*                                              by Jeff Gohlke    2014/04/17 */
...
int main(int argc, char *argv[])
{
    ...
    for (x = COLS - 1; ; --x) {
        if (LOGO == 1 && add_sl(x) == ERR) break;
        else if (C51 == 1 && add_C51(x) == ERR) break;
        else if (add_D51(x) == ERR) break;
        getch();
        refresh();
        usleep(40000);
    }
