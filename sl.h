...
#define UNICORNHIGHT 26
#define UNICORNLENGTH 72
#define UNICORNPATTERNS 1
...
#define UNICORN02 "                          //,/                             -~ |           "
#define UNICORN03 "                        // / |                         _-~   /  ,         "
#define UNICORN04 "                      /'/ / /                       _-~   _/_-~ |         "
#define UNICORN05 "                     ( ( / /'                   _ -~     _-~ ,/'          "
#define UNICORN06 "                      \\~\\/'/|             __--~~__--\\ _-~  _/,            "
#define UNICORN07 "              ,,)))))));, \\/~-_     __--~~  --~~  __/~  _-~ /             "
#define UNICORN08 "           __))))))))))))));,>/\\   /        __--~~  \\-~~ _-~              "
#define UNICORN09 "          -\\(((((''''(((((((( >~\\/     --~~   __--~' _-~ ~|               "
#define UNICORN10 " --==//////((''  .     `)))))), /     ___---~~  ~~\\~~__--~                "
#define UNICORN11 "         ))| @    ;-.     (((((/           __--~~~'~~/                    "
#define UNICORN12 "         ( `|    /  )      )))/      ~~~~~__\\__---~~__--~~--_             "
#define UNICORN13 "            |   |   |       (/      ---~~~/__-----~~  ,;::'  \\         ,  "
#define UNICORN14 "            o_);   ;        /      ----~~/           \\,-~~~\\  |       /|  "
#define UNICORN15 "                  ;        (      ---~~/         `:::|      |;|      < >  "
#define UNICORN16 "                 |   _      `----~~~~'      /      `:|       \\;\\_____//   "
#define UNICORN17 "           ______/\\/~    |                 /        /         ~------~    "
#define UNICORN18 "         /~;;.____/;;'  /          ___----(   `;;;/                       "
#define UNICORN19 "        / //  _;______;'------~~~~~    |;;/\\    /                         "
#define UNICORN20 "       //  | |                        /  |  \\;;,\\                         "
#define UNICORN21 "      (<_  | ;                      /',/-----'  _>                        "
#define UNICORN22 "       \\_| ||_                     //~;~~~~~~~~~                          "
#define UNICORN23 "           `\\_|                   (,~~                                    "
#define UNICORN24 "                                   \\~\\                                    "
#define UNICORN25 "                                    ~~                                    "
